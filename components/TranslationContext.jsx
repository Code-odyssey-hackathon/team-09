...
const TRANSLATIONS = {
  ...
  kn: {
    ...
    appAspect: 'ಅನುಪಾತ',
    appQualityNote1: 'ಒಂದೇ ಎಲೆಯ ಕ್ಲೋಸ್-ಅಪ್ ಫೋಟೋ ಬಳಸಿ.',
    appQualityNote2: 'ಉತ್ತಮ ನಿಖರತೆಗಾಗಿ ಹೊಳಪು ಮತ್ತು ನೆರಳನ್ನು ತಪ್ಪಿಸಿ.',
    appQualityNote3: 'ವಿಶ್ವಾಸಾರ್ಹ ಫಲಿತಾಂಶಗಳಿಗಾಗಿ ಪ್ರಕಾಶಮಾನ, ಕೇಂದ್ರಿತ ಚಿತ್ರಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
  ...
  ta: {
    ...
    appAspect: 'விகிதம்',
    appQualityNote1: 'ஒரே இலையின் க்ளோஸ்-அப் புகைப்படம் பயன்படுத்தவும்.',
    appQualityNote2: 'சிறந்த துல்லியத்திற்கு ஒளிவீச்சு மற்றும் நிழல்களை தவிர்க்கவும்.',
    appQualityNote3: 'நம்பகமான முடிவுகளுக்கு பிரகாசமான, மையப்படுத்தப்பட்ட படங்களை பதிவேற்றவும்.',
  ...
  te: {
    ...
    appAspect: 'నిష్పత్తి',
    appQualityNote1: 'ఒకే ఆకు యొక్క క్లోజ్-అప్ ఫోటో వాడండి.',
    appQualityNote2: 'ఉత్తమ ఖచ్చితత్వం కోసం మెరుపు మరియు నీడలు నివారించండి.',
    appQualityNote3: 'నమ్మకమైన ఫలితాల కోసం ప్రకాశవంతమైన, కేంద్రీకృత చిత్రాలను అప్‌లోడ్ చేయండి.',
